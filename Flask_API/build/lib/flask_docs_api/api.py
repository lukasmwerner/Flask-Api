...
class Api():
    ...
    def __init__(self, app:flask.Flask, docRoute:str, globalls:dict, apiName=""):
        '''Creates a new Flask-API Docs object. Needs a provided <code>app</code> and a provided <code>docRoute</code> for the location of the docs
        '''
        self.app = app
        self.globalls = globalls
    ...
    def __createDocs(self):
        ...
        '''
        globe = {}
        for (a, b) in self.globalls.items():
            globe[a] = b.__doc__
        routes = []
        ...
        #return flask.render_template('api.html', routes=routes, name=self.apiName)